...
public class ContaController
{
	...
	{
		int opc = 0;
		String[] menuPrincipal = { "Acessar Conta", "Criar Conta", "Sair", };
		while (opc != 3)
		{
	...
	public void menuConta()
	{
		...
		int opc = 0;
		String[] menuPrincipal = { "Saldo", "Depositar", "Sacar", "Extrato", "sair" };
		String dados = contas.getConta(indiceConta).getCliente().getPessoa().getNome()
				+ "\n"
				+ "Conta "
		...
		while (opc != menuPrincipal.length)
		{
			...
			{
				case 1:
					String saldo = df.format(contas.getConta(indiceConta).getSaldo());
				...
				case 3:
					...
					view.validarOperação(this.contas.getConta(indiceConta).sacar(saque));
					extrato.sacar(saque);
					break;
				case 4:
					boolean b = true;
	...
	public void criarCliente()
	{
		...
		int numConta = view.readInt("Digite o Número da Conta");
		Cliente novoCliente = new Cliente(numConta, nome, telefone, tipoTelefone, endereco);
